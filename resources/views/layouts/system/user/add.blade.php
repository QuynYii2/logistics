                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        @endif
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form method="post" action="/warehouse/checkadd">
                                                         @csrf
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Name</label>
                                                            <input type="text" name="name_warehouse" class="form-control" id="exampleInputName" aria-describedby="nameHelp" value = "" placeholder="Enter name">
                                                        </div>
                                                        <div class="form-group">
